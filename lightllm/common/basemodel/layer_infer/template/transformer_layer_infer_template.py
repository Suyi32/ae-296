...
class TransformerLayerInferTpl(TransformerLayerInfer):
    ...
    def _context_attention(self, input_embding, infer_state: InferStateInfo, time_breakdown, layer_weight):
        input1 = self._att_norm(input_embding, infer_state, layer_weight)
        cache_k, cache_v = self._pre_cache_kv(infer_state, layer_weight)
        q = self._get_qkv(input1, cache_k, cache_v, infer_state, layer_weight, time_breakdown)
        input1 = None
    ...
    def _token_attention(self, input_embding, infer_state: InferStateInfo, time_breakdown, layer_weight):
        input1 = self._att_norm(input_embding, infer_state, layer_weight)
        cache_k, cache_v = self._pre_cache_kv(infer_state, layer_weight)
        q = self._get_qkv(input1, cache_k, cache_v, infer_state, layer_weight, time_breakdown)
        input1 = None
    ...
    def context_forward(self, input_embdings, infer_state: InferStateInfo, layer_weight, time_breakdown):
    ...
    def token_forward(self, input_embdings, infer_state: InferStateInfo, layer_weight, time_breakdown):
